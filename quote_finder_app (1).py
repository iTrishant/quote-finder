# -*- coding: utf-8 -*-
"""quote_finder_app.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1pbLHMkwvKJH7qYQTY_E-tUhD7KodeYEB
"""
...
st.write("Type what you're feeling or searching for, and get wisdom from the greats.")

user_input = st.text_input("Enter your feeling, situation, or tag:", "")

if user_input:
    # Step 1: Try exact tag match
    input_clean = user_input.lower().strip()
    known_tags = set(mlb.classes_)

    if input_clean in known_tags:
        # Tag is directly found
    ...
    if matched_df.empty:
        ...
        user_vec = emb  # already computed earlier
        sim_scores = np.dot(quote_vecs, user_vec.T).flatten()
...
streamlit run quote_finder_app.py

# Commented out IPython magic to ensure Python compatibility.
# %%writefile quote_finder_app.py
# 
# import streamlit as st
# import pandas as pd
# import numpy as np
...
#     st.error("Something went wrong. Please try a different input.")
#     st.exception(e)

# !streamlit run quote_finder_app.py &>/content/logs.txt &

# !npm install -g localtunnel

# !npx localtunnel --port 8501 --subdomain quotefinder12345

# !pip install -q streamlit sentence-transformers scikit-learn pyngrok
